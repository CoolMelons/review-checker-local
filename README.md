...
| Date       | Area  | Product | Agency | Agency Code | Main Guide | People |
|------------|-------|---------|--------|-------------|------------|--------|
| 2026-01-27 | Seoul | 남이섬  | L      | ABC123      | 김철수     | 3      |
| 2026-01-27 | Seoul | 에버    | KK     | 25KK001     | 이영희     | 2      |
...
**크롬 연결 실패?**
- 크롬 완전 종료 후 디버깅 모드로 재실행

**리뷰를 못 찾음?**
- 크롬 디버깅 창에서 각 사이트에 로그인

**날짜 오류?**
- 엑셀 Date 컬럼 형식을 "날짜"로 설정
